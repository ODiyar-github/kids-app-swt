...
public class EventDTO {
    ...
    public List<InterestEnum> getCategory() { return category; }
    public void setCategory(List<InterestEnum> category) { this.category = category; }
    public List<EventFeedBackDto> getFeedBack() { return feedBack; }
    public void setFeedBack(List<EventFeedBackDto> feedBack) { this.feedBack = feedBack; }
